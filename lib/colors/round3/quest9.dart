...
class Quest9 extends StatefulWidget {
  late int totalScore;
  Quest9({required this.totalScore});
    ...
    _timer = Timer.periodic(Duration(seconds: 1), (timer) {
      setState(() {
        if (_counter > 0) {
          ...
          _timer.cancel();
          SharedPreferenceHelper().saveUserLevel3(widget.totalScore.toString());
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      ...
                      _timer.cancel();
                      SharedPreferenceHelper().saveUserAddress("YES");
                      SharedPreferenceHelper()
                          .saveUserLevel3(finalScore.toString());
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => RoundOver(
