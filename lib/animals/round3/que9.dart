...
class Que9 extends StatefulWidget {
  late int totalScore;
  Que9({required this.totalScore});

  @override
  _Que9State createState() => _Que9State();
}
    ...
    _timer = Timer.periodic(Duration(seconds: 1), (timer) {
      setState(() {
        if (_counter > 0) {
          ...
          _timer.cancel();
          SharedPreferenceHelper().saveUserLevel4(widget.totalScore.toString());
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      SharedPreferenceHelper()
                          .saveUserLevel4(finalScore.toString());
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => RoundOver(
