...
import 'package:quizapp/Day/round1/round2/mon6.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class mon5 extends StatefulWidget {
  late int totalScore;
  mon5({required this.totalScore});

  @override
  _mon5State createState() => _mon5State();
}

class _mon5State extends State<mon5> {
