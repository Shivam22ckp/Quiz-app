...
import 'package:quizapp/Day/round1/round2/mon11.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class mon10 extends StatefulWidget {
  late int totalScore;
  mon10({required this.totalScore});

  @override
  _mon10State createState() => _mon10State();
}

class _mon10State extends State<mon10> {
