...
import 'package:quizapp/Day/round1/round2/mon8.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class mon7 extends StatefulWidget {
  late int totalScore;
  mon7({required this.totalScore});

  @override
  _mon7State createState() => _mon7State();
}

class _mon7State extends State<mon7> {
