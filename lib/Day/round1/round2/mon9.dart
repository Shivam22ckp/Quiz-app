...
import 'package:quizapp/Day/round1/round2/mon10.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class mon9 extends StatefulWidget {
  late int totalScore;
  mon9({required this.totalScore});

  @override
  _mon9State createState() => _mon9State();
}

class _mon9State extends State<mon9> {
