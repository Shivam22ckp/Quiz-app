...
import 'package:quizapp/Day/round1/round2/mon3.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class mon2 extends StatefulWidget {
  late int totalScore;
  mon2({required this.totalScore});

  @override
  _mon2State createState() => _mon2State();
}

class _mon2State extends State<mon2> {
