...
import 'package:quizapp/Day/round1/round2/mon7.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class mon6 extends StatefulWidget {
  late int totalScore;
  mon6({required this.totalScore});

  @override
  _mon6State createState() => _mon6State();
}

class _mon6State extends State<mon6> {
