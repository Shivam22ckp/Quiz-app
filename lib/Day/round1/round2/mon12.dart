...
class mon12 extends StatefulWidget {
  late int totalScore;
  mon12({required this.totalScore});

  @override
  _mon12State createState() => _mon12State();
}

class _mon12State extends State<mon12> {
