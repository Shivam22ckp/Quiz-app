...
class mon8 extends StatefulWidget {
  late int totalScore;
  mon8({required this.totalScore});

  @override
  _mon8State createState() => _mon8State();
}

class _mon8State extends State<mon8> {
