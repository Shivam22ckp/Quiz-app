...
import 'package:quizapp/Day/round1/round2/mon4.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class mon3 extends StatefulWidget {
  late int totalScore;
  mon3({required this.totalScore});

  @override
  _mon3State createState() => _mon3State();
}

class _mon3State extends State<mon3> {
