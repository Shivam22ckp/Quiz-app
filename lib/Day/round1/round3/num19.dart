...
import 'package:quizapp/Day/round1/round3/num20.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class Num19 extends StatefulWidget {
  late int totalScore;
  Num19({required this.totalScore});

  @override
  _Num19State createState() => _Num19State();
}

class _Num19State extends State<Num19> {
