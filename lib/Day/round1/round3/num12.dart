...
import 'package:quizapp/Day/round1/round3/num11.dart';
import 'package:quizapp/Day/round1/round3/num13.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class Num12 extends StatefulWidget {
  late int totalScore;
  Num12({required this.totalScore});

  @override
  _Num12State createState() => _Num12State();
}

class _Num12State extends State<Num12> {
