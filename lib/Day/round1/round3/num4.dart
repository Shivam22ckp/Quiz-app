...
import 'package:quizapp/Day/round1/round3/num5.dart';
import 'package:quizapp/Day/round1/round3/num6.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class Num4 extends StatefulWidget {
  late int totalScore;
  Num4({required this.totalScore});

  @override
  _Num4State createState() => _Num4State();
}

class _Num4State extends State<Num4> {
