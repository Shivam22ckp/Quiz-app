...
class Num17 extends StatefulWidget {
  late int totalScore;
  Num17({required this.totalScore});

  @override
  _Num17State createState() => _Num17State();
}

class _Num17State extends State<Num17> {
