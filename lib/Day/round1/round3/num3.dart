...
import 'package:quizapp/Day/round1/round3/num4.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class Num3 extends StatefulWidget {
  late int totalScore;
  Num3({required this.totalScore});

  @override
  _Num3State createState() => _Num3State();
}

class _Num3State extends State<Num3> {
