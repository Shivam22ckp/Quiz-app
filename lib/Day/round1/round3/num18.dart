...
import 'package:quizapp/Day/round1/round3/num19.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class Num18 extends StatefulWidget {
  late int totalScore;
  Num18({required this.totalScore});

  @override
  _Num18State createState() => _Num18State();
}

class _Num18State extends State<Num18> {
