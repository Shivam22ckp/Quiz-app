...
import 'package:quizapp/Day/round1/round3/num7.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class Num6 extends StatefulWidget {
  late int totalScore;
  Num6({required this.totalScore});

  @override
  _Num6State createState() => _Num6State();
}

class _Num6State extends State<Num6> {
