...
import 'package:quizapp/Day/round1/round3/num12.dart';
import 'package:quizapp/Day/round1/round3/num14.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class Num11 extends StatefulWidget {
  late int totalScore;
  Num11({required this.totalScore});

  @override
  _Num11State createState() => _Num11State();
}

class _Num11State extends State<Num11> {
