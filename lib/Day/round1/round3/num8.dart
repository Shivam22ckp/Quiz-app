...
import 'package:quizapp/Day/round1/round3/num9.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class Num8 extends StatefulWidget {
  late int totalScore;
  Num8({required this.totalScore});

  @override
  _Num8State createState() => _Num8State();
}

class _Num8State extends State<Num8> {
