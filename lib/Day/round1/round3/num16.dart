...
import 'package:quizapp/Day/round1/round3/num18.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class Num16 extends StatefulWidget {
  late int totalScore;
  Num16({required this.totalScore});

  @override
  _Num16State createState() => _Num16State();
}

class _Num16State extends State<Num16> {
