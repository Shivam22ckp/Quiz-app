...
import 'package:quizapp/Day/round1/round3/num16.dart';
import 'package:quizapp/Day/round1/round3/num17.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';
import 'package:quizapp/sports/round1/Questio2.dart';

class Num15 extends StatefulWidget {
  late int totalScore;
  Num15({required this.totalScore});

  @override
  _Num15State createState() => _Num15State();
}

class _Num15State extends State<Num15> {
