...
import 'package:quizapp/Household/hs4.dart';
import 'package:quizapp/Household/round2/hs7.dart';
import 'package:quizapp/Household/round3/hs11.dart';
import 'package:quizapp/design_round/round1page.dart';
import 'package:quizapp/fruits/Round%201/Round2/question4.dart';

class hs10 extends StatefulWidget {
  late int totalScore;
  hs10({required this.totalScore});

  @override
  _hs10State createState() => _hs10State();
}

class _hs10State extends State<hs10> {
