...
import 'package:quizapp/Household/hs2.dart';
...
class hs12 extends StatefulWidget {
  late int totalScore;
  hs12({required this.totalScore});

  @override
  _hs12State createState() => _hs12State();
}

class _hs12State extends State<hs12> {
      ...
      setState(() {
        if (_counter > 0) {
          ...
          SharedPreferenceHelper()
              .saveUserLevel12(widget.totalScore.toString());
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      ...
                      SharedPreferenceHelper().savecomplevel12("YES");
                      SharedPreferenceHelper()
                          .saveUserLevel12(finalScore.toString());
                      _timer.cancel();
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
