...
class flo3 extends StatefulWidget {
  late int totalScore;
  flo3({required this.totalScore});

  @override
  _flo3State createState() => _flo3State();
}

class _flo3State extends State<flo3> {
