...
class ins9 extends StatefulWidget {
  late int totalScore;
  ins9({required this.totalScore});

  @override
  _ins9State createState() => _ins9State();
}

class _ins9State extends State<ins9> {
