...
class ins4 extends StatefulWidget {
  late int totalScore;
  ins4({required this.totalScore});

  @override
  _ins4State createState() => _ins4State();
}

class _ins4State extends State<ins4> {
