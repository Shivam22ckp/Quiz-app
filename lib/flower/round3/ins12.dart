...
class ins12 extends StatefulWidget {
  late int totalScore;
  ins12({required this.totalScore});

  @override
  _ins12State createState() => _ins12State();
}

class _ins12State extends State<ins12> {
