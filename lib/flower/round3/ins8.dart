...
class ins8 extends StatefulWidget {
  late int totalScore;
  ins8({required this.totalScore});

  @override
  _ins8State createState() => _ins8State();
}

class _ins8State extends State<ins8> {
