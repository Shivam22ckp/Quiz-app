...
import 'package:quizapp/flower/round3/ins12.dart';
import 'package:quizapp/flower/round3/ins16.dart';
import 'package:quizapp/flower/round3/ins20.dart';
import 'package:quizapp/flower/round3/ins4.dart';
import 'package:quizapp/flower/round3/ins8.dart';
import 'package:quizapp/fruits/Round%201/Round2/question5.dart';
import 'package:quizapp/pages/shared_pref.dart';

class ins19 extends StatefulWidget {
  late int totalScore;
  ins19({required this.totalScore});

  @override
  _ins19State createState() => _ins19State();
}

class _ins19State extends State<ins19> {
