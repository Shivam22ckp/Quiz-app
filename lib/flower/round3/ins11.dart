...
class ins11 extends StatefulWidget {
  late int totalScore;
  ins11({required this.totalScore});

  @override
  _ins11State createState() => _ins11State();
}

class _ins11State extends State<ins11> {
