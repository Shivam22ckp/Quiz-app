...
class ins7 extends StatefulWidget {
  late int totalScore;
  ins7({required this.totalScore});

  @override
  _ins7State createState() => _ins7State();
}

class _ins7State extends State<ins7> {
