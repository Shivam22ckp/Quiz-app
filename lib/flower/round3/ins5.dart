...
class ins5 extends StatefulWidget {
  late int totalScore;
  ins5({required this.totalScore});

  @override
  _ins5State createState() => _ins5State();
}

class _ins5State extends State<ins5> {
