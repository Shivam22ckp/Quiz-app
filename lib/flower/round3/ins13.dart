...
class ins13 extends StatefulWidget {
  late int totalScore;
  ins13({required this.totalScore});

  @override
  _ins13State createState() => _ins13State();
}

class _ins13State extends State<ins13> {
