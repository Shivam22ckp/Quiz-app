...
class flo8 extends StatefulWidget {
  late int totalScore;
  flo8({required this.totalScore});

  @override
  _flo8State createState() => _flo8State();
}

class _flo8State extends State<flo8> {
