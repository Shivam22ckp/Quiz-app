...
class flo13 extends StatefulWidget {
  late int totalScore;
  flo13({required this.totalScore});

  @override
  _flo13State createState() => _flo13State();
}

class _flo13State extends State<flo13> {
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      ...
                      _timer.cancel();
                      SharedPreferenceHelper().savecomplevel("YES");
                      SharedPreferenceHelper()
                          .saveUserLevel6(finalScore.toString());
