...
import 'package:quizapp/flower/round2/veg18.dart';
import 'package:quizapp/flower/round2/veg2.dart';
import 'package:quizapp/fruits/Round%201/Round2/question5.dart';

class veg17 extends StatefulWidget {
  late int totalScore;
  veg17({required this.totalScore});

  @override
  _veg17State createState() => _veg17State();
}

class _veg17State extends State<veg17> {
