...
import 'package:quizapp/flower/round2/veg20.dart';
import 'package:quizapp/flower/round2/veg4.dart';
...
class veg19 extends StatefulWidget {
  late int totalScore;
  veg19({required this.totalScore});

  @override
  _veg19State createState() => _veg19State();
}

class _veg19State extends State<veg19> {
