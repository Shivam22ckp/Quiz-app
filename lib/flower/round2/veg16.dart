...
import 'package:quizapp/flower/round2/veg17.dart';
import 'package:quizapp/flower/round2/veg5.dart';
import 'package:quizapp/fruits/Round%201/Round2/question6.dart';

class veg16 extends StatefulWidget {
  late int totalScore;
  veg16({required this.totalScore});

  @override
  _veg16State createState() => _veg16State();
}

class _veg16State extends State<veg16> {
