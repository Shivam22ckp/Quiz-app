...
import 'package:quizapp/flower/round2/veg14.dart';
import 'package:quizapp/flower/round2/veg2.dart';
import 'package:quizapp/fruits/Round%201/Round2/question5.dart';

class veg13 extends StatefulWidget {
  late int totalScore;
  veg13({required this.totalScore});

  @override
  _veg13State createState() => _veg13State();
}

class _veg13State extends State<veg13> {
