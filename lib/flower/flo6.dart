...
class flo6 extends StatefulWidget {
  late int totalScore;
  flo6({required this.totalScore});

  @override
  _flo6State createState() => _flo6State();
}

class _flo6State extends State<flo6> {
