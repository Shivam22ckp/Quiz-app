...
class bod3 extends StatefulWidget {
  late int totalScore;
  bod3({required this.totalScore});

  @override
  _bod3State createState() => _bod3State();
}

class _bod3State extends State<bod3> {
