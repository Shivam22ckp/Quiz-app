...
class bod5 extends StatefulWidget {
  late int totalScore;
  bod5({required this.totalScore});

  @override
  _bod5State createState() => _bod5State();
}

class _bod5State extends State<bod5> {
