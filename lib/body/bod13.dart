...
class bod13 extends StatefulWidget {
  late int totalScore;
  bod13({required this.totalScore});

  @override
  _bod13State createState() => _bod13State();
}

class _bod13State extends State<bod13> {
