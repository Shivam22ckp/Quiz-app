...
import 'package:quizapp/body/bod22.dart';
import 'package:quizapp/body/bod6.dart';
import 'package:quizapp/fruits/Round%201/question2.dart';

class bod21 extends StatefulWidget {
  late int totalScore;
  bod21({required this.totalScore});

  @override
  _bod21State createState() => _bod21State();
}

class _bod21State extends State<bod21> {
