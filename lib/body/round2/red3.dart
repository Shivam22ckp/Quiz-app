...
class red3 extends StatefulWidget {
  late int totalScore;
  red3({required this.totalScore});

  @override
  _red3State createState() => _red3State();
}

class _red3State extends State<red3> {
