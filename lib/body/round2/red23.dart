...
class red23 extends StatefulWidget {
  late int totalScore;
  red23({required this.totalScore});

  @override
  _red23State createState() => _red23State();
}

class _red23State extends State<red23> {
