...
class red7 extends StatefulWidget {
  late int totalScore;
  red7({required this.totalScore});

  @override
  _red7State createState() => _red7State();
}

class _red7State extends State<red7> {
