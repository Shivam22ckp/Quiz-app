...
class red15 extends StatefulWidget {
  late int totalScore;
  red15({required this.totalScore});

  @override
  _red15State createState() => _red15State();
}

class _red15State extends State<red15> {
