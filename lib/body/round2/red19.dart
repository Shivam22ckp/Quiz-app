...
class red19 extends StatefulWidget {
  late int totalScore;
  red19({required this.totalScore});

  @override
  _red19State createState() => _red19State();
}

class _red19State extends State<red19> {
