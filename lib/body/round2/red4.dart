...
class red4 extends StatefulWidget {
  late int totalScore;
  red4({required this.totalScore});

  @override
  _red4State createState() => _red4State();
}

class _red4State extends State<red4> {
