...
import 'package:quizapp/body/round2/red16.dart';
import 'package:quizapp/body/round2/red20.dart';
import 'package:quizapp/body/round2/red24.dart';
import 'package:quizapp/body/round2/red28.dart';
...
class red27 extends StatefulWidget {
  late int totalScore;
  red27({required this.totalScore});

  @override
  _red27State createState() => _red27State();
}

class _red27State extends State<red27> {
