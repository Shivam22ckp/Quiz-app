...
class bod9 extends StatefulWidget {
  late int totalScore;
  bod9({required this.totalScore});

  @override
  _bod9State createState() => _bod9State();
}

class _bod9State extends State<bod9> {
