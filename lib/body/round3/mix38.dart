...
class mix38 extends StatefulWidget {
  late int totalScore;
  mix38({required this.totalScore});

  @override
  _mix38State createState() => _mix38State();
}

class _mix38State extends State<mix38> {
