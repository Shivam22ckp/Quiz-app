...
class mix34 extends StatefulWidget {
  late int totalScore;
  mix34({required this.totalScore});

  @override
  _mix34State createState() => _mix34State();
}

class _mix34State extends State<mix34> {
