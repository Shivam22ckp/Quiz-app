...
class mix15 extends StatefulWidget {
  late int totalScore;
  mix15({required this.totalScore});

  @override
  _mix15State createState() => _mix15State();
}

class _mix15State extends State<mix15> {
