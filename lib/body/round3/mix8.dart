...
class mix8 extends StatefulWidget {
  late int totalScore;
  mix8({required this.totalScore});

  @override
  _mix8State createState() => _mix8State();
}

class _mix8State extends State<mix8> {
