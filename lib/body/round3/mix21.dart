...
class mix21 extends StatefulWidget {
  late int totalScore;
  mix21({required this.totalScore});

  @override
  _mix21State createState() => _mix21State();
}

class _mix21State extends State<mix21> {
