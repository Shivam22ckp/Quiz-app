...
class mix37 extends StatefulWidget {
  late int totalScore;
  mix37({required this.totalScore});

  @override
  _mix37State createState() => _mix37State();
}

class _mix37State extends State<mix37> {
