...
class mix4 extends StatefulWidget {
  late int totalScore;
  mix4({required this.totalScore});

  @override
  _mix4State createState() => _mix4State();
}

class _mix4State extends State<mix4> {
