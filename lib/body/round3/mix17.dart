...
class mix17 extends StatefulWidget {
  late int totalScore;
  mix17({required this.totalScore});

  @override
  _mix17State createState() => _mix17State();
}

class _mix17State extends State<mix17> {
