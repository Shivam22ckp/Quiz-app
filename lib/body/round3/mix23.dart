...
class mix23 extends StatefulWidget {
  late int totalScore;
  mix23({required this.totalScore});

  @override
  _mix23State createState() => _mix23State();
}

class _mix23State extends State<mix23> {
