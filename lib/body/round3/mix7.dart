...
class mix7 extends StatefulWidget {
  late int totalScore;
  mix7({required this.totalScore});

  @override
  _mix7State createState() => _mix7State();
}

class _mix7State extends State<mix7> {
