...
class mix10 extends StatefulWidget {
  late int totalScore;
  mix10({required this.totalScore});

  @override
  _mix10State createState() => _mix10State();
}

class _mix10State extends State<mix10> {
