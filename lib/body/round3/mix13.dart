...
class mix13 extends StatefulWidget {
  late int totalScore;
  mix13({required this.totalScore});

  @override
  _mix13State createState() => _mix13State();
}

class _mix13State extends State<mix13> {
