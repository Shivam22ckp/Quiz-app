...
class mix26 extends StatefulWidget {
  late int totalScore;
  mix26({required this.totalScore});

  @override
  _mix26State createState() => _mix26State();
}

class _mix26State extends State<mix26> {
