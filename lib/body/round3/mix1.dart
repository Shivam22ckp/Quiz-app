...
class mix1 extends StatefulWidget {
  late int totalScore;
  mix1({required this.totalScore});

  @override
  _mix1State createState() => _mix1State();
}

class _mix1State extends State<mix1> {
