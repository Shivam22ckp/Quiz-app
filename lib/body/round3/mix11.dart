...
class mix11 extends StatefulWidget {
  late int totalScore;
  mix11({required this.totalScore});

  @override
  _mix11State createState() => _mix11State();
}

class _mix11State extends State<mix11> {
