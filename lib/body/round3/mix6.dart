...
class mix6 extends StatefulWidget {
  late int totalScore;
  mix6({required this.totalScore});

  @override
  _mix6State createState() => _mix6State();
}

class _mix6State extends State<mix6> {
