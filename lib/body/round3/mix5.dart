...
class mix5 extends StatefulWidget {
  late int totalScore;
  mix5({required this.totalScore});

  @override
  _mix5State createState() => _mix5State();
}

class _mix5State extends State<mix5> {
