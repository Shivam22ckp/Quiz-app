...
import 'package:quizapp/body/round3/mix20.dart';
...
class mix19 extends StatefulWidget {
  late int totalScore;
  mix19({required this.totalScore});

  @override
  _mix19State createState() => _mix19State();
}

class _mix19State extends State<mix19> {
