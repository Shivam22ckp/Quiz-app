...
class mix2 extends StatefulWidget {
  late int totalScore;
  mix2({required this.totalScore});

  @override
  _mix2State createState() => _mix2State();
}

class _mix2State extends State<mix2> {
