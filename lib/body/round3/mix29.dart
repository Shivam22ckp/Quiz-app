...
class mix29 extends StatefulWidget {
  late int totalScore;
  mix29({required this.totalScore});

  @override
  _mix29State createState() => _mix29State();
}

class _mix29State extends State<mix29> {
