...
class mix42 extends StatefulWidget {
  late int totalScore;
  mix42({required this.totalScore});

  @override
  _mix42State createState() => _mix42State();
}

class _mix42State extends State<mix42> {
