...
class mix3 extends StatefulWidget {
  late int totalScore;
  mix3({required this.totalScore});

  @override
  _mix3State createState() => _mix3State();
}

class _mix3State extends State<mix3> {
