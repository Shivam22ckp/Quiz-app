...
class mix18 extends StatefulWidget {
  late int totalScore;
  mix18({required this.totalScore});

  @override
  _mix18State createState() => _mix18State();
}

class _mix18State extends State<mix18> {
