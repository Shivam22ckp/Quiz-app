...
class mix27 extends StatefulWidget {
  late int totalScore;
  mix27({required this.totalScore});

  @override
  _mix27State createState() => _mix27State();
}

class _mix27State extends State<mix27> {
