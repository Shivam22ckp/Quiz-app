...
class mix14 extends StatefulWidget {
  late int totalScore;
  mix14({required this.totalScore});

  @override
  _mix14State createState() => _mix14State();
}

class _mix14State extends State<mix14> {
