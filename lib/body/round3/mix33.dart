...
class mix33 extends StatefulWidget {
  late int totalScore;
  mix33({required this.totalScore});

  @override
  _mix33State createState() => _mix33State();
}

class _mix33State extends State<mix33> {
