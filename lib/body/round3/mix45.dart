...
class mix45 extends StatefulWidget {
  late int totalScore;
  mix45({required this.totalScore});

  @override
  _mix45State createState() => _mix45State();
}

class _mix45State extends State<mix45> {
