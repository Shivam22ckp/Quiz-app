...
class mix41 extends StatefulWidget {
  late int totalScore;
  mix41({required this.totalScore});

  @override
  _mix41State createState() => _mix41State();
}

class _mix41State extends State<mix41> {
