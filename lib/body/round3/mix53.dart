...
class mix53 extends StatefulWidget {
  late int totalScore;
  mix53({required this.totalScore});

  @override
  _mix53State createState() => _mix53State();
}

class _mix53State extends State<mix53> {
