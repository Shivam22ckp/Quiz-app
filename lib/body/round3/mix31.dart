...
class mix31 extends StatefulWidget {
  late int totalScore;
  mix31({required this.totalScore});

  @override
  _mix31State createState() => _mix31State();
}

class _mix31State extends State<mix31> {
