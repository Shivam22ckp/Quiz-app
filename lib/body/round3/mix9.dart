...
class mix9 extends StatefulWidget {
  late int totalScore;
  mix9({required this.totalScore});

  @override
  _mix9State createState() => _mix9State();
}

class _mix9State extends State<mix9> {
