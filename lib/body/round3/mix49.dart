...
import 'package:quizapp/body/round3/mix30.dart';
import 'package:quizapp/body/round3/mix34.dart';
import 'package:quizapp/body/round3/mix38.dart';
import 'package:quizapp/body/round3/mix46.dart';
import 'package:quizapp/body/round3/mix50.dart';
...
class mix49 extends StatefulWidget {
  late int totalScore;
  mix49({required this.totalScore});

  @override
  _mix49State createState() => _mix49State();
}

class _mix49State extends State<mix49> {
