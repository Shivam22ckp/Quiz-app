...
import 'package:quizapp/body/round3/mix52.dart';
...
class mix51 extends StatefulWidget {
  late int totalScore;
  mix51({required this.totalScore});

  @override
  _mix51State createState() => _mix51State();
}

class _mix51State extends State<mix51> {
