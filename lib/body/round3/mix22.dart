...
class mix22 extends StatefulWidget {
  late int totalScore;
  mix22({required this.totalScore});

  @override
  _mix22State createState() => _mix22State();
}

class _mix22State extends State<mix22> {
