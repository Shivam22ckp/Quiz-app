...
class bod4 extends StatefulWidget {
  late int totalScore;
  bod4({required this.totalScore});

  @override
  _bod4State createState() => _bod4State();
}

class _bod4State extends State<bod4> {
