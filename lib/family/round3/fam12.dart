...
class Fam12 extends StatefulWidget {
  late int totalScore;
  Fam12({required this.totalScore});

  @override
  _Fam12State createState() => _Fam12State();
}

class _Fam12State extends State<Fam12> {
      ...
      setState(() {
        if (_counter > 0) {
          ...
          SharedPreferenceHelper()
              .saveUserLevel11(widget.totalScore.toString());
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      ...
                      _timer.cancel();
                      SharedPreferenceHelper().savecomplevel11("YES");
                      SharedPreferenceHelper()
                          .saveUserLevel11(finalScore.toString());
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => RoundOver(
