...
import 'package:quizapp/family/round3/fam11.dart';

class Fam10 extends StatefulWidget {
  late int totalScore;
  Fam10({required this.totalScore});

  @override
  _Fam10State createState() => _Fam10State();
}

class _Fam10State extends State<Fam10> {
