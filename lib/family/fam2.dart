...
class Fam2 extends StatefulWidget {
  late int totalScore;
  Fam2({required this.totalScore});

  @override
  _Fam2State createState() => _Fam2State();
}

class _Fam2State extends State<Fam2> {
