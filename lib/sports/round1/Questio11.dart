...
class Questio11 extends StatefulWidget {
  late int totalScore;
  Questio11({required this.totalScore});

  @override
  _Questio11State createState() => _Questio11State();
}

class _Questio11State extends State<Questio11> {
