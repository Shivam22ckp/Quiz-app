...
class Questio3 extends StatefulWidget {
  late int totalScore;
  Questio3({required this.totalScore});

  @override
  _Questio3State createState() => _Questio3State();
}

class _Questio3State extends State<Questio3> {
