...
class Questio6 extends StatefulWidget {
  late int totalScore;
  Questio6({required this.totalScore});

  @override
  _Questio6State createState() => _Questio6State();
}

class _Questio6State extends State<Questio6> {
