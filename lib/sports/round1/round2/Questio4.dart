...
import 'package:quizapp/sports/round1/round2/Questio5.dart';

class Questio4 extends StatefulWidget {
  late int totalScore;
  Questio4({required this.totalScore});

  @override
  _Questio4State createState() => _Questio4State();
}

class _Questio4State extends State<Questio4> {
