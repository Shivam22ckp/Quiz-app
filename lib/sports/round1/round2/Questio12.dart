...
class Questio12 extends StatefulWidget {
  late int totalScore;
  Questio12({required this.totalScore});

  @override
  _Questio12State createState() => _Questio12State();
}

class _Questio12State extends State<Questio12> {
