...
import 'package:quizapp/sports/round1/round3/Questio8.dart';

class Questio7 extends StatefulWidget {
  late int totalScore;
  Questio7({required this.totalScore});

  @override
  _Questio7State createState() => _Questio7State();
}

class _Questio7State extends State<Questio7> {
