...
class Questio9 extends StatefulWidget {
  late int totalScore;
  Questio9({required this.totalScore});

  @override
  _Questio9State createState() => _Questio9State();
}

class _Questio9State extends State<Questio9> {
    ...
    _timer = Timer.periodic(Duration(seconds: 1), (timer) {
      setState(() {
        if (_counter > 0) {
          ...
          _timer.cancel();
          SharedPreferenceHelper().saveUserLevel2(widget.totalScore.toString());
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      ...
                      _timer.cancel();
                      SharedPreferenceHelper().saveUserEmail("YES");
                      SharedPreferenceHelper()
                          .saveUserLevel2(finalScore.toString());
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => RoundOver(
