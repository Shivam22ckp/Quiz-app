...
class Questio13 extends StatefulWidget {
  late int totalScore;
  Questio13({required this.totalScore});

  @override
  _Questio13State createState() => _Questio13State();
}

class _Questio13State extends State<Questio13> {
